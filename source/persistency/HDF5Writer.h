...
namespace nexus {
  ...
  public:
    ...
    void WriteStep(int64_t evt_number,
                   ...
                   float time);
    void WriteGammaInteraction(int64_t evt_number, int particle_id, const char* particle_name, char primary, int mother_id, float initial_x, float initial_y, float initial_z, float initial_t, float final_x, float final_y, float final_z, float final_t, const char* initial_volume, const char* final_volume, float initial_momentum_x, float initial_momentum_y, float initial_momentum_z, float final_momentum_x, float final_momentum_y, float final_momentum_z, float kin_energy, float length, const char* creator_proc, const char* final_proc);
  ...
  private:
    ...
    size_t memtypeStep_;
    size_t memtypeGammaInteraction_;
    ...
    size_t igamma_; ///< counter for gamma interactions
