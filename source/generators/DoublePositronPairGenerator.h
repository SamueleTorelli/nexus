// ----------------------------------------------------------------------------
// nexus | DoublePositronPairGenerator.h
//
...
#ifndef DOUBLEPOSITRON_PAIR_GEN_H
#define DOUBLEPOSITRON_PAIR_GEN_H
...
namespace nexus {
  ...
  class DoublePositronPairGenerator: public G4VPrimaryGenerator
  {
  public:
    /// Constructor
    DoublePositronPairGenerator();
    /// Destructor
    ~DoublePositronPairGenerator();
