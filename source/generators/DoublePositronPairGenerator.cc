// ----------------------------------------------------------------------------
// nexus | DoublePositronPairGenerator.cc
//
...
#include "DoublePositronPairGenerator.h"
...
REGISTER_CLASS(DoublePositronPairGenerator, G4VPrimaryGenerator)

DoublePositronPairGenerator::DoublePositronPairGenerator():
G4VPrimaryGenerator(), msg_(0), particle_definition_(0),
energy_min_(0.), energy_max_(0.),
geom_(0)
{
  msg_ = new G4GenericMessenger(this, "/Generator/DoublePositronPair/",
...
void DoublePositronPairGenerator::GeneratePrimaryVertex(G4Event* event)
{
